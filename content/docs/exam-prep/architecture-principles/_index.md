...
2. **[자동화 금지 영역 4가지와 판단 체크리스트](automation-control-boundaries)** — IAM·보안 그룹, Stateful 마이그레이션, 비용 자동 삭제 등 자동화가 함정이 되는 패턴과 4가지 판단 기준
3. **[API Gateway 429 오류와 Throttling 전략](api-gateway-throttling)** — 429 vs 502 오류의 원인 차이, Usage Plan 조정·재시도·캐싱을 통한 해결 전략
